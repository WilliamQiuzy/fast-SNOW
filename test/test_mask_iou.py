...
class TestMaskIoU:
    ...
    def test_identical_masks(self):
        ...
        assert ROSEPipeline._mask_iou(m, m) == pytest.approx(1.0)
    ...
    def test_no_overlap(self):
        ...
        a[0:5, :] = True
        b[5:10, :] = True
        assert ROSEPipeline._mask_iou(a, b) == pytest.approx(0.0)
    ...
    def test_partial_overlap(self):
        ...
        assert ROSEPipeline._mask_iou(a, b) == pytest.approx(20.0 / 100.0)
    ...
    def test_subset_mask(self):
        ...
        assert ROSEPipeline._mask_iou(big, small) == pytest.approx(16.0 / 100.0)
    ...
    def test_both_full(self):
        ...
        b = np.ones((10, 10), dtype=bool)
        assert ROSEPipeline._mask_iou(a, b) == pytest.approx(1.0)
    ...
    def test_single_pixel_overlap(self):
        ...
        assert ROSEPipeline._mask_iou(a, b) == pytest.approx(1.0 / 25.0)
    ...
    def test_asymmetric_sizes(self):
        ...
        assert ROSEPipeline._mask_iou(a, b) == pytest.approx(4.0 / 64.0)
    ...
    def test_commutative(self):
        ...
        a[0:6, :] = True
        b[3:10, :] = True
        assert ROSEPipeline._mask_iou(a, b) == pytest.approx(
            ROSEPipeline._mask_iou(b, a)
        )
