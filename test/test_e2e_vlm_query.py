"""Quick e2e test: synth_003.mp4 → ROSE 4DSG → GPT-5.2 answer."""
import os
import sys
...
from rose.engine.config import ROSEConfig, VLMConfig
...
def main():
    print("=" * 60)
    print("ROSE E2E Test: synth_003.mp4 → GPT-5.2")
    print("=" * 60)

    # Config: use OpenAI GPT-5.2, full video
    from rose.engine.config import SamplingConfig
    config = ROSEConfig(
